...
_BACKEND_ALIASES = {
    # Local pre-plugin Brave configs used ``web.backend: brave``.  Upstream's
    # provider is named ``brave-free``; preserve the old spelling as a thin
    # compatibility alias so existing config keeps working after update.
    "brave": "brave-free",
}
