...
MEMORY_SCHEMA = {
    ...
    "description": (
        ...
        "single lone change.\n\n"
        "WHEN: the always-on stores are an intentional, keeper-reviewed surface — write when "
        "the user asks for an entry to be always-on, or when they explicitly approve one. "
        "Facts you merely want to keep belong in fact_store (recalled by query), not here. "
        "Priority when writing: user preferences & corrections > environment facts > procedures. The best "
