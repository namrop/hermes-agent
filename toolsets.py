...
_HERMES_CORE_TOOLS = [
    # Web
    "web_search", "web_extract", "authenticated_web_extract", "stealth_web_extract",
...
TOOLSETS = {
    ...
    "web": {
        ...
        "tools": ["web_search", "web_extract", "authenticated_web_extract", "stealth_web_extract"],
    ...
    "skills": {
        ...
        "tools": ["skills_list", "skill_view", "skill_manage", "beam_photon"],
        "includes": []
    },
